...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleSaveNote(event: FormEvent) {
    ...
    if (content === "") {
      toast.error("Você precisa adicionar um conteúdo para criar uma nota.");
      return;
    }
  ...
  function handleStartRecording() {
    ...
    const isSpeechReocgnitionApiAvailable = 'SpeechRecogntion' in window
    || 'webkitSpeechRecognition' in window

    if (!isSpeechReocgnitionApiAvailable) {
